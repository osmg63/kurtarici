          ...
          <Row className="text-center">
            <Col >
              ...
              <Button
                ...
                className="fw-bold d-none d-md-inline-flex" // 👈 sadece md ve üzeri görünür
      ...
      <section id="about" className="py-5">
        <Container>
          <Row className="align-items-center">
            ...
            <Col md={6} lg={4}  style={{ paddingLeft: '5%' }}>
              <img
                src={foto1}
                alt="Gaziantep Oto Kurtarma Hakkimizda"
